...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListMenu.add("Pancake");
        mListMenu.add("Pisang Nugget");
        mListMenu.add("Chocolate Float");
        mListMenu.add("Ice Cream");//memasukan info ke spinner
